...
use webrender;
use webrender_api::{self, HitTestFlags, HitTestResult};
...
impl<Window: WindowMethods> IOCompositor<Window> {
    ...
    fn composite_specific_target(&mut self,
        ...
        let width = self.embedder_coordinates.framebuffer.width as usize;
        let height = self.embedder_coordinates.framebuffer.height as usize;
