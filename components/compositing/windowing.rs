...
pub struct EmbedderCoordinates {
    ...
    /// Size of the screen.
    pub screen: TypedSize2D<usize, DevicePixel>,
    /// Size of the available screen space (screen without toolbars and docks).
    pub screen_avail: TypedSize2D<usize, DevicePixel>,
    /// Size of the native window.
    pub window: (TypedSize2D<usize, DevicePixel>, TypedPoint2D<i32, DevicePixel>),
