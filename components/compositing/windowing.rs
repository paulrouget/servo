...
use gleam::gl;
use msg::constellation_msg::{FrameId, Key, KeyModifiers, KeyState, NavigationReason};
...
pub trait WindowMethods {
    ...
    fn history_changed(&self, frame_id: FrameId, Vec<LoadData>, usize);
