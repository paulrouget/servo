...
pub fn Java_org_mozilla_servo_NativeServo_version(env: JNIEnv, _class: JClass) -> jstring {
...
#[no_mangle]
#[allow(non_snake_case)]
pub fn Java_org_mozilla_servo_NativeServo_init(
    env: JNIEnv,
    _: JClass,
    url: JString,
    wakeup_obj: JObject,
...
#[no_mangle]
#[allow(non_snake_case)]
pub fn Java_org_mozilla_servo_NativeServo_resize(
    env: JNIEnv,
    _: JClass,
    width: jint,
    height: jint,
...
#[no_mangle]
#[allow(non_snake_case)]
pub fn Java_org_mozilla_servo_NativeServo_performUpdates(env: JNIEnv, _class: JClass) {
...
#[no_mangle]
#[allow(non_snake_case)]
pub fn Java_org_mozilla_servo_NativeServo_loadUri(env: JNIEnv, _class: JClass, url: JString) {
    debug!("loadUri");
...
#[no_mangle]
#[allow(non_snake_case)]
pub fn Java_org_mozilla_servo_NativeServo_reload(env: JNIEnv, _class: JClass) {
    debug!("reload");
    call(env, |s| s.reload());
}
...
#[no_mangle]
#[allow(non_snake_case)]
pub fn Java_org_mozilla_servo_NativeServo_goBack(env: JNIEnv, _class: JClass) {
    debug!("goBack");
...
#[no_mangle]
#[allow(non_snake_case)]
pub fn Java_org_mozilla_servo_NativeServo_goForward(env: JNIEnv, _class: JClass) {
    debug!("goForward");
...
#[no_mangle]
#[allow(non_snake_case)]
pub fn Java_org_mozilla_servo_NativeServo_scroll(
    env: JNIEnv,
    _: JClass,
    dx: jint,
    dy: jint,
...
#[no_mangle]
#[allow(non_snake_case)]
pub fn Java_org_mozilla_servo_NativeServo_click(env: JNIEnv, _: JClass, x: jint, y: jint) {
    debug!("click");
